Firmware for the Mobi3-Pen. It uses circuitpython (https://circuitpython.org) and installation is as simple as dragging and dropping the files into your circuitpython drive. 
